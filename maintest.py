...
print("Tests fichier")
print(fichier.dict_cadence)
print(fichier.dict_employes)
print(fichier.dict_nettoyage)
print(fichier.dict_operateurs)
print(fichier.employes)
print(fichier.journee)
print(fichier.operateurs)
