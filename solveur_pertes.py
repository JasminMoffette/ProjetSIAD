...
class SolveurSechage(solveur.Solveur):
    ...
    def solve(self, probleme = prob1.SaputoProbleme1):
        ...
        #Lire le fichier .mod
        ampl.read(os.path.normpath('C:/Users/Darks/Desktop/ProjetSIAD/4.OptiPertesAmpl/OptiPertes.mod'))
        ...
        df_peremption = pd.DataFrame(probleme.sechages)
        ampl.get_parameter("delai_peremption").set_values(df_peremption)
